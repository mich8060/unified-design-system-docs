import { Avatar, Button, Divider, Layout, Text, Toggle, Dropdown, Code, Menu, SearchInput, Tag, Modal, Toast } from "@chg-ds/unified-design-system";
...
const LIVE_PREVIEW_BRANDS = ["default", "comphealth", "weatherby", "connect", "chg", "wireframe"] as const;
type LivePreviewBrand = (typeof LIVE_PREVIEW_BRANDS)[number];
type LivePreviewModal = "alert" | "content" | "fullscreen" | null;
...
const ALL_DOCTORS: DoctorRecord[] = [
    { name: "Dr. Amelia Rivera", initials: "AR", image: "https://i.pravatar.cc/128?img=5" },
    { name: "Dr. Benjamin Cole", initials: "BC", image: "https://i.pravatar.cc/128?img=12" },
    { name: "Dr. Chloe Nguyen", initials: "CN", image: "https://i.pravatar.cc/128?img=20" },
    { name: "Dr. Daniel Patel", initials: "DP", image: "https://i.pravatar.cc/128?img=33" },
    { name: "Dr. Elena Morris", initials: "EM", image: "https://i.pravatar.cc/128?img=44" },
    { name: "Dr. Farah Hassan", initials: "FH", image: "https://i.pravatar.cc/128?img=47" },
    { name: "Dr. Gabriel Lee", initials: "GL", image: "https://i.pravatar.cc/128?img=58" },
    { name: "Dr. Hannah Kim", initials: "HK", image: "https://i.pravatar.cc/128?img=61" },
];
...
export function AppShellDemoPage() {
    ...
    const [useDoctorPhotos, setUseDoctorPhotos] = useState(true);
    const [livePreviewBrand, setLivePreviewBrand] = useState<LivePreviewBrand>("chg");
    const [showLiveToast, setShowLiveToast] = useState(false);
    const [activeLiveModal, setActiveLiveModal] = useState<LivePreviewModal>(null);
    ...
    const livePreviewIdentity = livePreviewBrand === "default" ? "design-system" : livePreviewBrand;
    const closeLiveModal = () => setActiveLiveModal(null);
        ...
        >
            <Layout direction="column" gap="48">
                ...
                <Layout direction="column" gap="12">
                    ...
                    <Layout
                        className={`brand-${livePreviewBrand} theme-light`}
                        style={{ width: "100%", paddingBottom: "var(--uds-spacing-4)" }}
                    >
                        <div
                            ref={livePreviewContainerRef}
                            className="app-shell-live-preview-container"
                            style={{ width: "1280px", minWidth: "1280px", height: "800px" }}
                        >
                            <Layout
                                style={{
                                    border: "var(--uds-border-width-1) solid var(--uds-border-primary)",
                            ...
                            >
                                <Layout alignItems="center" gap="12" wrap>
                                    ...
                                    <Layout alignItems="center" gap="8">
                                        <Toggle checked={showFooter} onChange={setShowFooter} size="small" />
                                        <Text as="span" variant="body-14" leading="regular">
                                            Footer
                                        </Text>
                                    </Layout>
                                    <Layout alignItems="center" gap="8">
                                        <Toggle checked={useDoctorPhotos} onChange={setUseDoctorPhotos} size="small" />
                                        <Text as="span" variant="body-14" leading="regular">
                                            Use Photos
                                        </Text>
                                    </Layout>
                                ...
                                <Layout alignItems="center" gap="8" wrap>
                                    <Button
                                        ...
                                        appearance="outline"
                                        label="Show Toast"
                                        onClick={() => setShowLiveToast(true)}
                                    />
                                    <Button
                                        size="xsmall"
                                        appearance="outline"
                                        label="Alert Modal"
                                        onClick={() => setActiveLiveModal("alert")}
                                    />
                                    <Button
                                        size="xsmall"
                                        appearance="outline"
                                        label="Content Modal"
                                        onClick={() => setActiveLiveModal("content")}
                                    />
                                    <Button
                                        size="xsmall"
                                        appearance="outline"
                                        label="Full Window Modal"
                                        onClick={() => setActiveLiveModal("fullscreen")}
                                    />
                                </Layout>
                            </Layout>
                            ...
                            >
                                <aside className="app-shell__sidebar" style={{ position: "relative" }}>
                                    <Menu
                                        ...
                                        brands={[...LIVE_PREVIEW_BRANDS]}
                                        activeBrand={livePreviewBrand}
                                        identity={livePreviewIdentity}
                                        onBrandChange={(value) => {
                                            if (LIVE_PREVIEW_BRANDS.includes(value as LivePreviewBrand)) {
                                                setLivePreviewBrand(value as LivePreviewBrand);
                                            }
                                        }}
                                        showSearch
                                        showBrandSwitcher
                                ...
                                <Layout style={{ flex: 1, minWidth: 0, position: "relative", overflow: "hidden" }}>
                                    ...
                                    >
                                        ...
                                        <Layout direction="column" style={{ minWidth: 380 }}>
                                            {PREVIEW_DOCTORS.map((doctor) => (
                                                ...
                                                >
                                                    <Avatar
                                                        src={useDoctorPhotos ? doctor.image : undefined}
                                                        name={doctor.name}
                                    ...
                                    <Layout direction="column" style={{ flex: 1, minWidth: 0, position: "relative", zIndex: 1 }}>
                                        ...
                                        >
                                            ...
                                            <Layout alignItems="center" gap="8">
                                                ...
                                                <Button appearance="text" size="xsmall" label="Open Profile" />
                                            </Layout>
                                        </Layout>
                                        <Layout
                                            direction="column"
                                        ...
                                        >
                                            ...
                                            >
                                                <Layout alignItems="center" gap="10">
                                                    <Avatar
                                                        src={useDoctorPhotos ? selectedDoctor?.image : undefined}
                                                        name={selectedDoctor?.name}
                                                        initials={selectedDoctor?.initials ?? "DR"}
                                                        size="default"
                                                    />
                                                ...
                                                <Layout alignItems="center" gap="6">
                                                    <Tag label="Active" color="green" solid rounded />
                                                    <Tag label="Premium" color="blue" solid rounded />
                                                </Layout>
                                            </Layout>
                                            ...
                                            >
                                                <Layout alignItems="center" justifyContent="space-between">
                                                    <Text as="span" variant="body-12" leading="regular">Assignment</Text>
                                                    <Text as="span" variant="body-14" weight="semibold" leading="regular">Locum Cardiology - Nights</Text>
                                                </Layout>
                                                <Layout alignItems="center" justifyContent="space-between">
                                                    <Text as="span" variant="body-12" leading="regular">Facility</Text>
                                                    <Text as="span" variant="body-14" weight="semibold" leading="regular">St. Mary's Medical Center</Text>
                                                </Layout>
                                                <Layout alignItems="center" justifyContent="space-between">
                                                    <Text as="span" variant="body-12" leading="regular">Shift Window</Text>
                                                    <Text as="span" variant="body-14" weight="semibold" leading="regular">Aug 12 - Sep 09</Text>
                                                </Layout>
                                                <Layout alignItems="center" justifyContent="space-between">
                                                    <Text as="span" variant="body-12" leading="regular">Credentialing</Text>
                                                    <Tag label="2 tasks pending" color="orange" solid rounded />
                                                </Layout>
                                            </Layout>

                                            <Layout alignItems="center" gap="8" wrap>
                                                <Button label="View Schedule" appearance="outline" size="xsmall" />
                                                <Button label="Start Check-In" size="xsmall" />
                                                <Button label="Escalate Issue" appearance="text" size="xsmall" />
                                            </Layout>

                                            <Divider variant="solid" style={{ width: "100%" }} />
                                            <Text as="p" variant="body-14" leading="regular">
                                                This section reflects the active provider from Listview and updates as you switch rows.
                                                Use "Use Photos" to swap avatars between profile images and initials.
                                            </Text>
                                        </Layout>
                                        {showFooter ? (
                                            <Layout
                                                ...
                                                style={{
                                                    ...
                                                    borderTop: "var(--uds-border-width-1) solid var(--uds-border-secondary)",
                                                    backgroundColor: "var(--uds-surface-primary)",
                                    ...
                                    {showSidePanel ? (
                                        <aside
                                            className="app-shell__side-panel"
                            ...
                            {showLiveToast ? (
                                <Layout
                                    style={{
                                        ...
                                        left: "50%",
                                        bottom: showFooter
                                            ? "calc(100px + var(--uds-spacing-16))"
                                            : "var(--uds-spacing-16)",
                                        transform: "translateX(-50%)",
                                        width: "min(560px, calc(100% - var(--uds-spacing-24)))",
                                        zIndex: 40,
                                    }}
                                >
                                    <Toast
                                        title="Notification"
                                        message="This is a generic toast message."
                                        variant="info"
                                        actions="close"
            ...
            <Modal
                open={activeLiveModal === "alert"}
                onClose={closeLiveModal}
                header={<Text as="h3" variant="heading-24">Alert</Text>}
                size="small"
                footer={
                    <Layout alignItems="center" gap="8">
                        <Button label="Cancel" appearance="outline" onClick={closeLiveModal} />
                        <Button label="Confirm" onClick={closeLiveModal} />
                    </Layout>
                }
            >
                <Text as="p" variant="body-14" leading="regular">
                    Please review this alert and confirm to continue.
                </Text>
            </Modal>

            <Modal
                open={activeLiveModal === "content"}
                onClose={closeLiveModal}
                header={<Text as="h3" variant="heading-24">Content Modal</Text>}
                size="default"
                footer={
                    <Layout alignItems="center" gap="8">
                        <Button label="Close" appearance="outline" onClick={closeLiveModal} />
                        <Button label="Save" onClick={closeLiveModal} />
                    </Layout>
                }
            >
                <Layout direction="column" gap="8">
                    <Text as="p" variant="body-14" leading="regular">
                        This is a content modal example for the live preview.
                    </Text>
                    <Text as="p" variant="body-14" leading="regular">
                        Add forms, review details, or multi-step guidance here.
                    </Text>
                </Layout>
            </Modal>

            <Modal
                open={activeLiveModal === "fullscreen"}
                onClose={closeLiveModal}
                header={<Text as="h3" variant="heading-24">Full Window Modal</Text>}
                size="fullscreen"
                container={livePreviewContainerRef.current ?? undefined}
                footer={
                    <Layout alignItems="center" gap="8">
                        <Button label="Exit" appearance="outline" onClick={closeLiveModal} />
                        <Button label="Complete" onClick={closeLiveModal} />
                    </Layout>
                }
            >
                <Layout direction="column" gap="8">
                    <Text as="p" variant="body-14" leading="regular">
                        Fullscreen modals are useful for complex workflows and broader context.
                    </Text>
                    <Text as="p" variant="body-14" leading="regular">
                        Keep actions clear so users can complete or exit confidently.
                    </Text>
                </Layout>
            </Modal>
