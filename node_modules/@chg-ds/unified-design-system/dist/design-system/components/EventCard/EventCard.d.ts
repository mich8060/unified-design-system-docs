 ...
 */
export default function EventCard({ title, type, status, badge, icon, startCap, endCap, onClick, className, ...rest }: EventCardProps): import("react/jsx-runtime").JSX.Element;
