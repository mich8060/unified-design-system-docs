 ...
 */
export default function Toast({ message, variant, title, leading, icon, appearance, actions, size, avatarSrc, avatarInitials, showIcon, showClose, primaryActionLabel, secondaryActionLabel, onPrimaryAction, onSecondaryAction, onClose, className, ...props }: ToastProps): import("react/jsx-runtime").JSX.Element;
