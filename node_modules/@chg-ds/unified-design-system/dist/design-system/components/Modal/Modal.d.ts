 ...
 */
declare function Modal({ open, onClose, title, subtitle, badge, header, footer, size, closeOnBackdrop, closeOnEscape, dismissible, headerActions, headerAlign, footerAlign, bodyPadding, container, className, children, ...props }: ModalProps): React.ReactPortal | null;
